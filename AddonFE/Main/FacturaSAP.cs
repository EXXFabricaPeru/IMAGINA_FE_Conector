...
namespace AddonFE.Main
{
    class FacturaSAP
    {
            ...
            try
            {
                ...
                */
                   ...
                   && (pVal.EventType == SAPbouiCOM.BoEventTypes.et_CLICK) && pVal.Before_Action && pVal.ItemUID == "btnRever")
                {
                    ...
                    {
                        new FacturaDAO().SMC_ActualizarEstadoFE(ObjType, docentry, "Comprobante de retención dado de baja", "04", oCompany);
                    }
                    #endregion
                ...
                && (pVal.EventType == SAPbouiCOM.BoEventTypes.et_CLICK) && pVal.Before_Action && pVal.ItemUID == "btnFE")
                {
                    ...
                    string tramaZipCDR = "";
                    bool rptaRegistrar = RegistrarDocumento(Convert.ToInt32(numerosap), ObjType, tipodocumento, ref mregistrado, true, DocEntry, ref tramaZipCDR, oform);
                    ...
                    && (pVal.EventType == SAPbouiCOM.BoEventTypes.et_CLICK) && pVal.Before_Action && pVal.ItemUID == "btnFE8")
                {
                    ...
                    if (Status.ToUpper() == "ERROR")
                    {
                        ...
                        if (mensajeError.ToUpper().Contains("EL DOCUMENTO YA FUE FIRMADO"))
                        {
                            new FacturaDAO().ResumenAnulacionActualizar(docentry, Convert.ToInt32(pVal.FormTypeEx), ObjType, oCompany, ref mensajeerror);
                        }
                        Program.SboAplicacion.MessageBox("Error : " + mensajeError);
        ...
        public bool RegistrarDocumento(int docmun, int objectype, string tipodocumento, ref bool mregistrado, bool tiempo, int docentry, ref string TramaCdr, SAPbouiCOM.Form oform)
        {
            bool result = false;
            ...
            try
            {
                ...
                */
                ...
                try
                {
                    ...
                    {
                        new FacturaDAO().SMC_ActualizarEstadoFE(objectype, docentry, "Documento enviado a OSE", "01", oCompany);
                        ...
                        if (objectype == 15)
                        {
                            odocumentosap = (SAPbouiCOM.BoFormObjectEnum)objectype;
                        }
